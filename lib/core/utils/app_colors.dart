...
class AppColors {
  static const primary = Color(0xFFFA9A0C);
  static const blacktitle = Color(0xFF1E1E1E);
  static const blackbold = Color(0xFF000000);
  ...
  static const greys = Color(0xFFC4C4C4);
  static const greystyle = Color(0xFFAFAFAF);
}
